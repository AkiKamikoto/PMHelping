...
import { LayoutDashboard, KanbanSquare, Timer, BarChart3, BellRing, Download, Upload, FolderKanban } from 'lucide-react'
...
export type View = 'dashboard' | 'board' | 'time' | 'reports' | 'reminders'
      ...
      >
        ...
        {NAV.map(({ id, label, icon: Icon }) => (
          <button
            ...
            style={{
              background: view === id ? 'color-mix(in srgb, var(--series-1) 14%, transparent)' : 'transparent',
